...
public class QQGroup2 extends QQView implements QQView.IsParent {
    ...
    public QQGroup2(int direct) {
        this.direct = direct;
    }

    public QQGroup2(int direct, int innerMargin) {
        this.direct = direct;
    ...
    public void arrangeChildren() {
        ...
        if (DIRECT_VERTICAL == direct) {
            ...
            // reset position
            float anchorY = height - bottomPadding;
            for (QQView v : childrenView) {
