...
/*    @IntDef(flag = true, value = {
     ...
     */
    public static final Varier MAX_ATTACK_10P   = new Varier(Type.LIMIT | Type.ATTACK | Type.PERCENT, 10);
    public static final Varier MAX_DEFENSE_10P  = new Varier(Type.LIMIT | Type.DEFENSE | Type.PERCENT, 10);
