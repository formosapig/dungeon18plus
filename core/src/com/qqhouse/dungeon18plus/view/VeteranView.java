...
public class VeteranView extends AssetGroupButton {
    ...
    public void reset(Veteran veteran) {
        ...
        equip.setSize(32, 32);
        equip.setPosition(leftPadding + 48 + 4, 24);
        addChild(equip);
    ...
    public void arrangeChildren() {
        ...
        coolDown.setPosition(this.width - rightPadding - coolDown.getWidth(), 32);
        ...
        if (null != oper) {
            ...
            int startX = (int) (this.width - coolDown.getWidth() + 48 + leftPadding - rightPadding - OpsWidth + 4 + 32) / 2;
            for (int i = 0; i < oper.length; ++i) {
                oper[i].setPosition(startX, 32);
