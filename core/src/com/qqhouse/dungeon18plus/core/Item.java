...
//    WHITE_POTION(    0x7BD2A32A, Loot.TYPE_POTION,     0,  0,  0,   0,  0, "white_potion", "white_potion", "white_potion_help),
    ...
    TRAINING_DAGGER( 0x9CD6C0D7, "wooden_dagger", "training_dagger", "training_help",
            Type.NORMAL | Type.DAGGER | Type.NOT_FOR_SALE, 1, ATTACK_1, SPEED_1, KEY_10 ),
    ...
    IRON_DAGGER_2( 0xCEB28D7B, "iron_dagger", "iron_dagger_2", "iron_2_help",
            Type.REFINED | Type.DAGGER, 66, ATTACK_7, SPEED_3),
    WIND_DAGGER_1( 0x0E038F13, "wind_dagger", "wind_dagger_1", "crusader_forge_help",
            Type.REFINED | Type.DAGGER, 75, ATTACK_6, SPEED_4, KEY_11),
    ELVEN_DAGGER( 0x2BFAA035, "mithril_dagger", "elven_dagger", "elven_help",
    ...
    TRAINING_SWORD(0xBBE61C40, "wooden_sword", "training_sword", "training_help",
            Type.NORMAL | Type.SWORD | Type.NOT_FOR_SALE, 1, ATTACK_3, STAR_10),
    ...
    IRON_SWORD_2(0xA296DEEB, "iron_sword", "iron_sword_2", "iron_2_help",
            Type.REFINED | Type.SWORD, 66, ATTACK_13),
    GREAT_SWORD_1(0x9BDB2E93, "great_sword", "great_sword_1", "crusader_forge_help",
            Type.REFINED | Type.SWORD, 75, ATTACK_17, SPEED_N2),
    ELVEN_SWORD(0xCC37D7CB, "mithril_sword", "elven_sword", "elven_help",
    ...
    TRAINING_STAFF(0xD0DBC509, "wooden_staff", "training_staff", "training_help",
            Type.NORMAL | Type.STAFF | Type.NOT_FOR_SALE, 1, ATTACK_4, SPEED_N2, COIN_10),
    ...
    ELVEN_STAFF(0xEAF4F321, "mithril_staff", "elven_staff", "elven_help",
    ...
    TRAINING_SHIELD(0x0B21512E, "wooden_shield", "training_shield", "training_help",
            Type.NORMAL | Type.SHIELD | Type.NOT_FOR_SALE, 1, DEFENSE_3, STAR_10),
    ...
    IRON_SHIELD_2(0x109A983D, "iron_shield", "iron_shield_2", "iron_2_help",
            Type.REFINED | Type.SHIELD, 66, DEFENSE_13),
    TOWER_SHIELD_1(0xCF8FD117, "tower_shield", "tower_shield_1", "crusader_forge_help",
            Type.REFINED | Type.SHIELD, 75, DEFENSE_17, SPEED_N2),
    ELEVEN_SHIELD(0x52A976EC, "mithril_shield", "elven_shield", "elven_help",
    ...
    TRAINING_RING(0x78A8FA4A, "wooden_ring", "training_ring", "training_help",
            Type.NORMAL | Type.RING | Type.NOT_FOR_SALE, 1, DEFENSE_1, SPEED_1, KEY_3, COIN_3, STAR_4),
    ...
    IRON_RING_2(0x5D179F43, "iron_ring", "iron_ring_2", "iron_2_help",
    ...
    IRON_BOOTS_2(0x2198046A, "iron_boots", "iron_boots_2", "iron_2_help",
            Type.REFINED | Type.BOOTS, 66, DEFENSE_3, SPEED_5),
    ELVEN_BOOTS(0x34E4283E, "mithril_boots", "elven_boots", "elven_help",
