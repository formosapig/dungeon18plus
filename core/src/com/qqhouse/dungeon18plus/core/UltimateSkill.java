...
public enum UltimateSkill {
	 ...
	 */
	// 普攻 3 -> 4 隻的差別
	ATTACK_UP( "icon32_attack",                 0x1F255EAF, 125, 125, new OpSt(AS_ATK,   16,   16,  ME,  ME)),
	// 防禦增加一點點
	DEFENSE_UP( "icon32_defense",               0x6972C4F3, 125, 125, new OpSt(AS_DEF,   10,   10,  ME,  ME)),
	// 速度增加
	SPEED_UP( "icon32_speed",                   0x5EFB585F, 130, 130, new OpSt(AS_SPD,   -2,   -2,  ME,  ME)),
