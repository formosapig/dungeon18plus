...
public enum Soul {
	 ...
	 */
	// R1 : 
	SMALL_BAG( 0xF586B7F7, 1, 1, "item/golden_coin") {
		@Override
	...
	// R2 :
	MEDIUM_BAG( 0x2F91B821, 2, 1, "item/golden_coin") {
		@Override
		public int getGoldenCoin() {
	...
	// R4 :
	BIG_BAG( 0x2D5E1F4B, 4, 1, "item/golden_coin") {
		@Override
		public int getGoldenCoin() {
	...
	// R7 
	HUGE_BAG( 0xCDB26EE8, 7, 1, "item/golden_coin") {
		@Override
		public int getGoldenCoin() {
	...
	NEGATIVE_STAR( 0x748D17B4, 1, 3, "item/broken_black_soul") {
		@Override
	 ...
	 *      1 * 40 = 40 (star)
	 */
	STAR( 0x9480E2D8, 4, 8, "item/complete_black_soul") {
		@Override
        public Variety[] getInfluence(int count) {
	 ...
	 *      0.875 * 20 = 17.5 (coin) 
	 */
	NEGATIVE_COIN( 0x59C3FED9, 1, 3, "item/broken_black_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
                    Variety.ATTACK_N1,
	 ...
	 *      1 * 80 = 80 (coin)
	 */
	COIN( 0x7C78490B, 4, 8, "item/complete_black_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 *    0.95 * 10 = 9.5  (star) ~> 9
	 */
	NEGATIVE_LUCKY( 0x987CA3CB, 2, 5, "item/complete_black_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 */
	KEY( 0xC2BC6C6E, 6, 5, "item/complete_black_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 *      1.5 * 100 = 150 (life) 
	 */
	NEGATIVE_LIFE( 0x830591A0, 2, 3, "item/broken_yellow_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 * 
	 */
	LONG_LIFE( 0xAA388930, 3, 5, "item/broken_yellow_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 *     1.5 * 100 = 150  
	 */
	LIFE( 0xF3CA11D7, 4, 3, "item/complete_yellow_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 *      1.95 * 4 = 7.8 
	 */
	NEGATIVE_ATTACK( 0x80161B2D, 2, 3, "item/broken_red_soul") {
		@Override
        public Variety[] getInfluence(int count) {
		    return new Variety[] {
	 ...
	 *     3.25 * 4 = 13 
	 */
	BERSERK( 0xDC7776BB, 3, 4, "item/broken_red_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 *   
	 */
	ATTACK( 0x22EA9185, 4, 4, "item/complete_red_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 * 
	 */
	NEGATIVE_DEFENSE( 0x4C3C74BA, 2, 3, "item/broken_blue_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 *      5 * 4 = 20 
	 */
	HARD_DEFENSE( 0x10C0E49C, 3, 4, "item/broken_blue_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 *      2 * 4 = 8
	 */
	DEFENSE( 0xDC894F5B, 4, 4, "item/complete_blue_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 *      1.5 * 2 = 3 
	 */
	NEGATIVE_SPEED( 0x31E2E774, 2, 3, "item/broken_green_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 *      2.875 * 2= 5.75
	 */
	RUNAWAY( 0xC3A77D4E, 3, 3, "item/broken_green_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 *      2.5 * 2 = 5
	 */
	SPEED( 0x0A1A981B, 4, 5, "item/complete_green_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
                    new Variety(Variety.Type.SPEED | Variety.Type.OFFSET, - count)
	 ...
	 *      0.5 * 4   = 2
	 */
	PROTECT( 0xF23B16C6, 4, 2, "item/complete_cyan_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 * 
	 */
	CHARGE( 0x38AE3194, 4, 3, "item/complete_purple_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            return new Variety[] {
	 ...
	 * 
	 */
	BRAVE(0x21EE5B97, 5, 8, "item/broken_white_soul") {
        @Override
        public Variety[] getInfluence(int count) {
		    if (8 <= count) {
	 ...
	 * 
	 */
	DREAM(0x643AD8E5, 5, 8, "item/broken_white_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            if (8 <= count) {
	 ...
	 *      0.5 x 20 = 10
	 */
	HOPE(0x4DA9FA4F, 5, 8, "item/broken_white_soul") {
        @Override
        public Variety[] getInfluence(int count) {
            if (8 <= count) {
