...
public enum UniqueSkill {
    ...
    IRON_DAGGER_2( "item/iron_dagger", "bg_refined",
                                                0x40316696, 155, 155, new OpSt(DG_ATK,  260,  360,   2,   2)),
    WIND_DAGGER_1( "item/wind_dagger", "bg_refined",
		                                        0x8A165F34, 200, 140, new OpSt(DG_ATK,  200,  250,   2,   8)),
    ELVEN_DAGGER( "item/mithril_dagger", "bg_blessed",
			                                    0x77623E7B, 120, 120, new OpSt(DG_ATK,  240,  240,   2,   2),
                                                                      new OpSt(AS_LIF,  125,  250,  ME,  ME)),
    ...
    MITHRIL_SWORD( "item/mithril_sword",        0x3BF6A14C, 200, 200, new OpSt(DG_ATK,  350,  350,   1,   1),
                                                                      new OpSt(AS_LIF,  100,  200,  ME,  ME)),
    IRON_SWORD_2( "item/iron_sword", "bg_refined",
		                                    	0x6F630AA2, 200, 200, new OpSt(DG_ATK,  500,  700,   1,   1)),
    GREAT_SWORD_1( "item/great_sword", "bg_refined",
		                                    	0xB77E8C3C, 250, 160, new OpSt(DG_ATK,  360, 1020,   1,   1)),
    ELVEN_SWORD( "item/mithril_sword", "bg_blessed",
		                                        0x82929DBB, 160, 160, new OpSt(DG_ATK,  420,  420,   1,   1),
                                                                      new OpSt(AS_LIF,  125,  250,  ME,  ME)),
    ...
    MITHRIL_STAFF( "item/mithril_staff",        0x9B74E27C, 350, 350, new OpSt(DG_LIF,  120,  120,   1,   1),
                                                                      new OpSt(AS_LIF,  100,  200,  ME,  ME)),
    ELVEN_STAFF( "item/mithril_staff", "bg_blessed",
			                                    0x5500220C, 280, 280, new OpSt(DG_LIF,  150,  150,   1,   1),
                                                                      new OpSt(AS_LIF,  125,  250,  ME,  ME)),
    ...
    MITHRIL_SHIELD( "item/mithril_shield",      0x58F9A9A3, 200, 200, new OpSt(AS_GRT,    5,    5,  ME,  ME),
                                                                      new OpSt(AS_LIF,  100,  200,  ME,  ME)),
    IRON_SHIELD_2( "item/iron_shield", "bg_refined",
		                                     	0x23315BF1, 200, 200, new OpSt(AS_GRT,   10,   14,  ME,  ME)),
    TOWER_SHIELD_1( "item/tower_shield", "bg_refined",
		                                     	0x752D1440, 250, 160, new OpSt(AS_GRT,   24,   24,  ME,  ME),
                                                                      new OpSt(AS_SPR,   50,   25,  ME,  ME)),
    ELVEN_SHIELD( "item/mithril_shield", "bg_blessed",
		                                       	0x659D8C34, 160, 160, new OpSt(AS_GRT,    6,    6,  ME,  ME),
                                                                      new OpSt(AS_LIF,  125,  250,  ME,  ME)),
    ...
    IRON_RING( "item/iron_ring",                0x712B97C9, 125, 125, new OpSt(AS_ATK,    2,    4, ALL, ALL),
                                                                      new OpSt(AS_DEF,    2,    4, ALL, ALL)),
    IRON_RING_1( "item/iron_ring", "bg_refined",
                                                0xB6678B8A, 140, 140, new OpSt(AS_ATK,    3,    5, ALL, ALL),
                                                                      new OpSt(AS_DEF,    3,    5, ALL, ALL)),
    ...
    IRON_RING_2( "item/iron_ring", "bg_refined",
		                                     	0x7B224123, 155, 155, new OpSt(AS_ATK,    4,    6, ALL, ALL),
                                                                      new OpSt(AS_DEF,    4,    6, ALL, ALL)),
    ...
    MITHRIL_BOOTS( "item/mithril_boots",        0xFE182408, 160, 160, new OpSt(DG_SPD, 2800, 2800,   3,   5),
                                                                      new OpSt(AS_LIF,  100,  200,  ME,  ME)),
    IRON_BOOTS_2( "item/iron_boots", "bg_refined",
			                                    0x5EAD7864, 140, 140, new OpSt(DG_SPD, 3100, 3500,   3,   5)),
    ELVEN_BOOTS( "item/mithril_boots", "bg_blessed",
		                                    	0xE0FEB3CF, 128, 128, new OpSt(DG_SPD, 3360, 3360,   3,   5),
                                                                      new OpSt(AS_LIF,  125,  250,  ME,  ME)),
